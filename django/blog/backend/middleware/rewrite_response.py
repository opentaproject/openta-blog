...
class ResponseRewriteMiddleware(MiddlewareMixin):
    def process_response(self, request, response):
        ...
        r = { 'OpenTA-category-not-selected' : 'inline-block border border-white rounded hover:border-gray-200 text-blue-500 hover:bg-gray-200 py-1 px-3',\
            ...
            'OpenTA-post-list' : 'h-full border border-gray-300 rounded-lg bg-white shadow-md text-xs',\
            ...
            'OpenTA-post-selected-entry' : 'border bg-blue-400 border-gray-300 p-2 rounded-lg bg-yellow-100  shadow-md',\
            'OpenTA-post-entry' : 'border bg-blue-400 border-gray-300 p-2 rounded-lg bg-green-100  shadow-md',\
            'OpenTA-post-body' : 'border  border-gray-300 p-4 rounded-lg bg-yellow-100  shadow-md',\
