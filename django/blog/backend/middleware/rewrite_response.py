...
class ResponseRewriteMiddleware(MiddlewareMixin):
    def process_response(self, request, response):
        r = { 
            ...
            'OpenTA-alias' : ' p-1 px-4 text-sm text-gray-900 bg-gray-150 rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ', \
            'OpenTA-visibility' : 'px-2 gap-4 inline-flex p-1 px-4 text-sm text-gray-900 bg-gray-150 rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ', \
            'OpenTA-title' : "font-semibold",\
            'OpenTA-alias' : "font-semibold",\
             }
